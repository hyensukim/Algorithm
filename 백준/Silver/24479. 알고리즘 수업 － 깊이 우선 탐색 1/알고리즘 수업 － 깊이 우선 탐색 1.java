 ...
 * - 재귀 함수 구현
 * 
 * 인접 리스트 생성 - 노드에 인접한 노드를 나타내는 리스트 배열
 * 방문 배열 생성 - 해당 노드에 방문여부를 확인하여 중복되는 방문을 줄여줌
 * 결과 배열 생성 - 해당 인덱스를 정점으로 생각하고, depth 값을 담아줍니다.
 * 정답 출력 시, 해당 노드의 깊이(depth)를 순서대로 담아줍니다.
